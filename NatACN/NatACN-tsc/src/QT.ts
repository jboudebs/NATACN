...
/**
 * Classe représentant un objet QT.
 */
export class QT {
    private _increment: SparklisSuggestion; //increment selon les types sparklis
    private _orientation: "Fwd" | "Bwd" | undefined; //orientation si c'est un IncrRel
     ...
     * @param {QT | SparklisSuggestion} qt - L'objet QT ou une suggestion Sparklis.
     * @param {string} [label] - Le libellé associé à l'objet QT.
     */
    constructor(qt: QT | SparklisSuggestion, label?: string) {
        if (qt instanceof QT) { //copie du QT
            this._increment = qt._increment;
            this._orientation = qt._orientation;
            ...
            // {
                this._orientation = qt.orientation; // Assigner une valeur par défaut si orientation est undefined
            //}
        }
    }
     ...
     */
    get orientation(): "Fwd" | "Bwd" | undefined {
        return this._orientation;
    }

    /**
     * Définit l'orientation de l'objet QT.
     * @param {"Fwd" | "Bwd" | undefined} value - La nouvelle orientation.
     */
    set orientation(value: "Fwd" | "Bwd" | undefined) {
